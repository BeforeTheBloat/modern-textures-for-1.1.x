...
///// find distance from the camera
	...
	///// water magic
#ifdef NEAR_WATER
	float3 laziness = float3(0.003921, 0.003921, 0.003921);
    float3 waterColour = float3(30, 151, 242);
	PSInput.color = float4(waterColour * laziness, 0.5);
	PSInput.color.a = 0.65;
#endif
